...
const Template = ({ size, className, checked, color, disabled }: CheckboxProps) => {
	const [isChecked, setIsChecked] = useState(false)
	return <Checkbox size={size} color={color} className={className} checked={isChecked} onChange={() => setIsChecked(value => !value)} disabled={disabled} >Hello</Checkbox>
};
;
