...
const defaultItem: Array<{
	url: string;
	title: string;
	id: number;
	icon?: keyof typeof HIcons;
}> = [
	{url: 'https://google.com', title: 'Profil', id: 1},
	{url: 'https://google.com', title: 'Test', id: 2},
	{
	...
	{url: 'https://google.com', title: 'Settings', id: 4},
	{url: 'https://google.com', title: 'Manage', id: 5},
	{url: 'https://google.com', title: 'Submit', id: 6},
];
